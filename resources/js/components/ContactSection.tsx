...
export default function ContactSection() {
    return (
        <section className="bg-white dark:bg-gray-900 container mx-auto px-14">
            <div className="container px-6 py-12 mx-auto">
                <div className="lg:flex lg:items-center lg:-mx-6">
                    <div className="lg:w-1/2 lg:mx-6">
                        <h1 className="text-2xl font-semibold text-gray-800 dark:text-white lg:text-3xl">
                            Laissez-nous un message pour plus d'informations .
                        </h1>
                        ...
                        <div className="mt-6 space-y-8 md:mt-8">
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 text-gray-700 truncate w-lg dark:text-gray-400">
                                    14e étage Tour Business (2 Tours jumelles), Mpila
                                </span>
                            </p>
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">(242) 064704970</span>
                            </p>
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">contact@anssi.cg</span>
                            </p>
                        </div>

                        <div className="mt-6 w-80 md:mt-8">
                            <h3 className="text-gray-600 dark:text-gray-300 ">Suivez nous sur</h3>
                    ...
                    <div className="mt-8 lg:w-1/2 lg:mx-6">
                        <div
                            ...
                            <h1 className="text-lg font-medium text-gray-700">Envoyez votre message</h1>

                            <form className="mt-6">
                                <div className="flex-1">
                                    <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Nom complet</label>
                                ...
                                <div className="flex-1 mt-6">
                                    <label className="block mb-2 text-sm text-gray-600 dark:text-gray-200">Adresse e-mail</label>
