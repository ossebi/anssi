                ...
                <div className="flex flex-wrap -mx-4">
                    ...
                    <div className="w-full lg:w-1/2 px-4 flex flex-col justify-center">
                        ...
                        <h2 className="text-3xl lg:text-3xl font-bold mb-4 text-blue-950 leading-tight tracking-wider">
                            Nous protégeons, détectons et répondons aux menaces numériques pour renforcer la résilience du pays.
                        </h2>
                        ...
                        <a
                            href="/about"
                            className="inline-flex items-center gap-2 border border-dashed border-sky-500 text-sky-700 px-6 py-3 rounded hover:bg-sky-700 hover:text-white hover:border-transparent transition w-52"
                        >
